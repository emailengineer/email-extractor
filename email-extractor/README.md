...
```bash
curl -sSL https://raw.githubusercontent.com/YOUR_USERNAME/email-extractor/main/install.sh | bash
```
...
Issues: https://github.com/YOUR_USERNAME/email-extractor/issues
